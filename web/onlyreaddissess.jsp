...
*/
    ...
    try {
        ...
        lastNum = pageNO * MaxNum;  //lastNum是该页显示的最后一条帖子的ID
        if (pageNO == 1) {
            prePage = 1;
        } else {
            prePage = pageNO - 1;
        ...
        String condition2 = "select * from discuss LIMIT " + firstNum +
                "," + lastNum;
        ...
        while (rs2.next()){
            ...
            id = rs2.getInt(7);
            out.print("<table align=center width=800 border=4 cellspacing=4 cellpadding = 4><tr><td width = 150 height = 40><font size = 5 ><a href=onlyreaddetail.jsp?id="+id+">" + subject + "</a></font></td><td width=150><font size=5>" + name + " </font></td><td width = 150 ><font size = 5 > "+time+" </font></td></tr>" );
        }
    } catch (Exception e) {
...
<table align="center" width="800" border="5" cellspacing="5" cellpadding="5">
    <tr>
        <td>
            <form action="onlyreaddissess.jsp" method="post">
                <table border="0">
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href=onlyreaddissess.jsp?pageNO=<%=firstPage%>>【第一页】</a>
                        </td>
                        <td>
                            <a href=onlyreaddissess.jsp?pageNO=<%=prePage%>>【上一页】 </a>
                        </td>
                        <td>
                            <a href=onlyreaddissess.jsp?pageNO=<%=nextPage%>>【下一页】 </a>
                        </td>
                        <td>
                            <a href=onlyreaddissess.jsp?pageNO=<%=lastPage%>>【最后一页】 </a>
                        </td>
                        <td>
                            输入页次：
...
<center><a href="onlyread.jsp">返回</a></center>
