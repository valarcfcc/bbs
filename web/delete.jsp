...
*/
    ...
    try {
        ...
        int id;
        out.print("<table align=center width=800 border=4 cellspacing=4 cellpadding=4><tr>" +
                "<td width = 150 height = 60 ><font size = 5 ></font ></td >" +
                "<td width = 150 height = 60 ><font size = 5 > 帖子主题</font ></td >" +
                "<td width = 150 ><font size = 5 > 发表者</font ></td >" +
                "<td width = 150 ><font size = 5 > 发表时间 </font></td></tr> ");
        out.print("<br><br><br><br><center><h2>删帖子</h2 ></center><br/>");
        while (rs2.next()){
            ...
            id = rs2.getInt(7);
            out.print("<table align=center width=800 border=4 cellspacing=4 cellpadding =4><tr>" +
                    "<td width = 150 height = 40><font size = 5 ><a href=x.jsp?id="+id+">delete</a></font></td>" +
                    "<td width = 150 height = 40><font size = 5 >" + subject + "</font></td>" +
                    "<td width=150><font size=5>" + name + " </font></td>" +
                    "<td width = 150 ><font size = 5 > "+time+" </font></td></tr>" );
        }
    } catch (Exception e) {
...
<center><a href="login.jsp">返回普通用户</a></center>
</body>
</html>
